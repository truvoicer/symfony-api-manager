...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\Api\\Backend\\AdminController' => 'getAdminControllerService',
            'App\\Controller\\Api\\Backend\\CategoryController' => 'getCategoryControllerService',
            'App\\Controller\\Api\\Backend\\PropertyController' => 'getPropertyControllerService',
            'App\\Controller\\Api\\Backend\\ProviderController' => 'getProviderControllerService',
            'App\\Controller\\Api\\Backend\\SearchController' => 'getSearchControllerService',
            'App\\Controller\\Api\\Backend\\Services\\ServiceController' => 'getServiceControllerService',
            'App\\Controller\\Api\\Backend\\Services\\ServiceRequestConfigController' => 'getServiceRequestConfigControllerService',
            'App\\Controller\\Api\\Backend\\Services\\ServiceRequestController' => 'getServiceRequestControllerService',
            'App\\Controller\\Api\\Backend\\Services\\ServiceRequestParameterController' => 'getServiceRequestParameterControllerService',
            'App\\Controller\\Api\\Backend\\Services\\ServiceRequestResponseKeyController' => 'getServiceRequestResponseKeyControllerService',
            'App\\Controller\\Api\\Backend\\Services\\ServiceResponseKeyController' => 'getServiceResponseKeyControllerService',
            'App\\Controller\\Api\\BaseController' => 'getBaseControllerService',
            'App\\Controller\\Api\\Frontend\\ListController' => 'getListControllerService',
            'App\\Controller\\Api\\Frontend\\OperationsController' => 'getOperationsControllerService',
    ...
    protected function getAuthControllerService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Service/SerializerService.php';

        $this->services['App\\Controller\\Api\\AuthController'] = $instance = new \App\Controller\Api\AuthController(($this->privates['App\\Service\\UserService'] ?? $this->getUserServiceService()), ($this->privates['App\\Service\\SerializerService'] ?? ($this->privates['App\\Service\\SerializerService'] = new \App\Service\SerializerService())), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()));
    ...
    /**
     * Gets the public 'App\Controller\Api\Backend\AdminController' shared autowired service.
     *
     * @return \App\Controller\Api\Backend\AdminController
     */
    protected function getAdminControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/BaseController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/Backend/AdminController.php';
        include_once \dirname(__DIR__, 4).'/src/Service/SerializerService.php';

        $this->services['App\\Controller\\Api\\Backend\\AdminController'] = $instance = new \App\Controller\Api\Backend\AdminController(($this->privates['App\\Service\\UserService'] ?? $this->getUserServiceService()), ($this->privates['App\\Service\\SerializerService'] ?? ($this->privates['App\\Service\\SerializerService'] = new \App\Service\SerializerService())), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\Api\\Backend\\AdminController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Api\Backend\CategoryController' shared autowired service.
     *
     * @return \App\Controller\Api\Backend\CategoryController
     */
    protected function getCategoryControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/BaseController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/Backend/CategoryController.php';
        include_once \dirname(__DIR__, 4).'/src/Service/SerializerService.php';

        $this->services['App\\Controller\\Api\\Backend\\CategoryController'] = $instance = new \App\Controller\Api\Backend\CategoryController(($this->privates['App\\Service\\SerializerService'] ?? ($this->privates['App\\Service\\SerializerService'] = new \App\Service\SerializerService())), ($this->privates['App\\Service\\CategoryService'] ?? $this->getCategoryServiceService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\Api\\Backend\\CategoryController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Api\Backend\PropertyController' shared autowired service.
     *
     * @return \App\Controller\Api\Backend\PropertyController
     */
    protected function getPropertyControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/BaseController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/Backend/PropertyController.php';
        include_once \dirname(__DIR__, 4).'/src/Service/SerializerService.php';

        $this->services['App\\Controller\\Api\\Backend\\PropertyController'] = $instance = new \App\Controller\Api\Backend\PropertyController(($this->privates['App\\Repository\\PropertyRepository'] ?? $this->getPropertyRepositoryService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()), ($this->privates['App\\Service\\PropertyService'] ?? $this->getPropertyServiceService()), ($this->privates['App\\Service\\SerializerService'] ?? ($this->privates['App\\Service\\SerializerService'] = new \App\Service\SerializerService())));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\Api\\Backend\\PropertyController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Api\Backend\ProviderController' shared autowired service.
     *
     * @return \App\Controller\Api\Backend\ProviderController
     */
    protected function getProviderControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/BaseController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/Backend/ProviderController.php';
        include_once \dirname(__DIR__, 4).'/src/Service/SerializerService.php';

        $this->services['App\\Controller\\Api\\Backend\\ProviderController'] = $instance = new \App\Controller\Api\Backend\ProviderController(($this->privates['App\\Repository\\ProviderRepository'] ?? $this->getProviderRepositoryService()), ($this->privates['App\\Service\\ProviderService'] ?? $this->getProviderServiceService()), ($this->privates['App\\Service\\SerializerService'] ?? ($this->privates['App\\Service\\SerializerService'] = new \App\Service\SerializerService())), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\Api\\Backend\\ProviderController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Api\Backend\SearchController' shared autowired service.
     *
     * @return \App\Controller\Api\Backend\SearchController
     */
    protected function getSearchControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/BaseController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/Backend/SearchController.php';
        include_once \dirname(__DIR__, 4).'/src/Service/SearchService.php';
        include_once \dirname(__DIR__, 4).'/src/Service/SerializerService.php';

        $a = ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService());

        $this->services['App\\Controller\\Api\\Backend\\SearchController'] = $instance = new \App\Controller\Api\Backend\SearchController(($this->privates['App\\Service\\SerializerService'] ?? ($this->privates['App\\Service\\SerializerService'] = new \App\Service\SerializerService())), $a, new \App\Service\SearchService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), $a, ($this->privates['App\\Service\\ProviderService'] ?? $this->getProviderServiceService()), ($this->privates['App\\Service\\RequestService'] ?? $this->getRequestServiceService()), ($this->privates['App\\Service\\CategoryService'] ?? $this->getCategoryServiceService()), ($this->privates['App\\Service\\ApiServicesService'] ?? $this->getApiServicesServiceService())));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\Api\\Backend\\SearchController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Api\Backend\Services\ServiceController' shared autowired service.
     *
     * @return \App\Controller\Api\Backend\Services\ServiceController
     */
    protected function getServiceControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/BaseController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/Backend/Services/ServiceController.php';
        include_once \dirname(__DIR__, 4).'/src/Service/SerializerService.php';

        $this->services['App\\Controller\\Api\\Backend\\Services\\ServiceController'] = $instance = new \App\Controller\Api\Backend\Services\ServiceController(($this->privates['App\\Service\\ProviderService'] ?? $this->getProviderServiceService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()), ($this->privates['App\\Service\\SerializerService'] ?? ($this->privates['App\\Service\\SerializerService'] = new \App\Service\SerializerService())), ($this->privates['App\\Service\\ApiServicesService'] ?? $this->getApiServicesServiceService()));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\Api\\Backend\\Services\\ServiceController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Api\Backend\Services\ServiceRequestConfigController' shared autowired service.
     *
     * @return \App\Controller\Api\Backend\Services\ServiceRequestConfigController
     */
    protected function getServiceRequestConfigControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/BaseController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/Backend/Services/ServiceRequestConfigController.php';
        include_once \dirname(__DIR__, 4).'/src/Service/SerializerService.php';

        $this->services['App\\Controller\\Api\\Backend\\Services\\ServiceRequestConfigController'] = $instance = new \App\Controller\Api\Backend\Services\ServiceRequestConfigController(($this->privates['App\\Service\\ProviderService'] ?? $this->getProviderServiceService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()), ($this->privates['App\\Service\\SerializerService'] ?? ($this->privates['App\\Service\\SerializerService'] = new \App\Service\SerializerService())), ($this->privates['App\\Service\\ApiServicesService'] ?? $this->getApiServicesServiceService()), ($this->privates['App\\Service\\RequestConfigService'] ?? $this->getRequestConfigServiceService()));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\Api\\Backend\\Services\\ServiceRequestConfigController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Api\Backend\Services\ServiceRequestController' shared autowired service.
     *
     * @return \App\Controller\Api\Backend\Services\ServiceRequestController
     */
    protected function getServiceRequestControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/BaseController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/Backend/Services/ServiceRequestController.php';
        include_once \dirname(__DIR__, 4).'/src/Service/SerializerService.php';

        $this->services['App\\Controller\\Api\\Backend\\Services\\ServiceRequestController'] = $instance = new \App\Controller\Api\Backend\Services\ServiceRequestController(($this->privates['App\\Service\\ProviderService'] ?? $this->getProviderServiceService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()), ($this->privates['App\\Service\\SerializerService'] ?? ($this->privates['App\\Service\\SerializerService'] = new \App\Service\SerializerService())), ($this->privates['App\\Service\\ApiServicesService'] ?? $this->getApiServicesServiceService()), ($this->privates['App\\Service\\RequestService'] ?? $this->getRequestServiceService()));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\Api\\Backend\\Services\\ServiceRequestController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Api\Backend\Services\ServiceRequestParameterController' shared autowired service.
     *
     * @return \App\Controller\Api\Backend\Services\ServiceRequestParameterController
     */
    protected function getServiceRequestParameterControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/BaseController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/Backend/Services/ServiceRequestParameterController.php';
        include_once \dirname(__DIR__, 4).'/src/Service/SerializerService.php';

        $this->services['App\\Controller\\Api\\Backend\\Services\\ServiceRequestParameterController'] = $instance = new \App\Controller\Api\Backend\Services\ServiceRequestParameterController(($this->privates['App\\Service\\ProviderService'] ?? $this->getProviderServiceService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()), ($this->privates['App\\Service\\SerializerService'] ?? ($this->privates['App\\Service\\SerializerService'] = new \App\Service\SerializerService())), ($this->privates['App\\Service\\ApiServicesService'] ?? $this->getApiServicesServiceService()), ($this->privates['App\\Service\\RequestParametersService'] ?? $this->getRequestParametersServiceService()));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\Api\\Backend\\Services\\ServiceRequestParameterController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Api\Backend\Services\ServiceRequestResponseKeyController' shared autowired service.
     *
     * @return \App\Controller\Api\Backend\Services\ServiceRequestResponseKeyController
     */
    protected function getServiceRequestResponseKeyControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/BaseController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/Backend/Services/ServiceRequestResponseKeyController.php';
        include_once \dirname(__DIR__, 4).'/src/Service/SerializerService.php';

        $this->services['App\\Controller\\Api\\Backend\\Services\\ServiceRequestResponseKeyController'] = $instance = new \App\Controller\Api\Backend\Services\ServiceRequestResponseKeyController(($this->privates['App\\Service\\ProviderService'] ?? $this->getProviderServiceService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()), ($this->privates['App\\Service\\SerializerService'] ?? ($this->privates['App\\Service\\SerializerService'] = new \App\Service\SerializerService())), ($this->privates['App\\Service\\ApiServicesService'] ?? $this->getApiServicesServiceService()), ($this->privates['App\\Service\\ResponseKeysService'] ?? $this->getResponseKeysServiceService()));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\Api\\Backend\\Services\\ServiceRequestResponseKeyController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Api\Backend\Services\ServiceResponseKeyController' shared autowired service.
     *
     * @return \App\Controller\Api\Backend\Services\ServiceResponseKeyController
     */
    protected function getServiceResponseKeyControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/BaseController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/Backend/Services/ServiceResponseKeyController.php';
        include_once \dirname(__DIR__, 4).'/src/Service/SerializerService.php';

        $this->services['App\\Controller\\Api\\Backend\\Services\\ServiceResponseKeyController'] = $instance = new \App\Controller\Api\Backend\Services\ServiceResponseKeyController(($this->privates['App\\Service\\ProviderService'] ?? $this->getProviderServiceService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()), ($this->privates['App\\Service\\SerializerService'] ?? ($this->privates['App\\Service\\SerializerService'] = new \App\Service\SerializerService())), ($this->privates['App\\Service\\ApiServicesService'] ?? $this->getApiServicesServiceService()), ($this->privates['App\\Service\\ResponseKeysService'] ?? $this->getResponseKeysServiceService()));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\Api\\Backend\\Services\\ServiceResponseKeyController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Api\BaseController' shared autowired service.
     *
     * @return \App\Controller\Api\BaseController
     */
    protected function getBaseControllerService()
    {
        ...
        $this->services['App\\Controller\\Api\\BaseController'] = $instance = new \App\Controller\Api\BaseController();

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\Api\\BaseController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Api\Frontend\ListController' shared autowired service.
     *
     * @return \App\Controller\Api\Frontend\ListController
     */
    protected function getListControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/BaseController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/Frontend/ListController.php';
        include_once \dirname(__DIR__, 4).'/src/Service/SerializerService.php';

        $this->services['App\\Controller\\Api\\Frontend\\ListController'] = $instance = new \App\Controller\Api\Frontend\ListController(($this->privates['App\\Service\\ProviderService'] ?? $this->getProviderServiceService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()), ($this->privates['App\\Service\\SerializerService'] ?? ($this->privates['App\\Service\\SerializerService'] = new \App\Service\SerializerService())), ($this->privates['App\\Service\\CategoryService'] ?? $this->getCategoryServiceService()));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\Api\\Frontend\\ListController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\Api\Frontend\OperationsController' shared autowired service.
     *
     * @return \App\Controller\Api\Frontend\OperationsController
     */
    protected function getOperationsControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/BaseController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/Api/Frontend/OperationsController.php';
        include_once \dirname(__DIR__, 4).'/src/Service/SerializerService.php';

        $this->services['App\\Controller\\Api\\Frontend\\OperationsController'] = $instance = new \App\Controller\Api\Frontend\OperationsController(($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()), ($this->privates['App\\Service\\SerializerService'] ?? ($this->privates['App\\Service\\SerializerService'] = new \App\Service\SerializerService())));

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\Api\\Frontend\\OperationsController', $this));
    ...
    protected function getConsole_CommandLoaderService()
    {
        ...
        return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Command\\CreateProviderCommand' => ['privates', 'App\\Command\\CreateProviderCommand', 'getCreateProviderCommandService', false],
            'App\\Command\\CreateUserCommand' => ['privates', 'App\\Command\\CreateUserCommand', 'getCreateUserCommandService', false],
            'App\\Command\\DeleteProviderCommand' => ['privates', 'App\\Command\\DeleteProviderCommand', 'getDeleteProviderCommandService', false],
            ...
            'App\\Command\\CreateProviderCommand' => 'App\\Command\\CreateProviderCommand',
            'App\\Command\\CreateUserCommand' => 'App\\Command\\CreateUserCommand',
            'App\\Command\\DeleteProviderCommand' => 'App\\Command\\DeleteProviderCommand',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\OauthAccessTokensRepository' => ['privates', 'App\\Repository\\OauthAccessTokensRepository', 'getOauthAccessTokensRepositoryService', false],
            ...
            'App\\Repository\\ProviderPropertyRepository' => ['privates', 'App\\Repository\\ProviderPropertyRepository', 'getProviderPropertyRepositoryService', false],
            ...
            'App\\Repository\\ServiceRequestConfigRepository' => ['privates', 'App\\Repository\\ServiceRequestConfigRepository', 'getServiceRequestConfigRepositoryService', false],
            'App\\Repository\\ServiceRequestParameterRepository' => ['privates', 'App\\Repository\\ServiceRequestParameterRepository', 'getServiceRequestParameterRepositoryService', false],
            'App\\Repository\\ServiceRequestRepository' => ['privates', 'App\\Repository\\ServiceRequestRepository', 'getServiceRequestRepositoryService', false],
            'App\\Repository\\ServiceRequestResponseKeyRepository' => ['privates', 'App\\Repository\\ServiceRequestResponseKeyRepository', 'getServiceRequestResponseKeyRepositoryService', false],
            'App\\Repository\\ServiceResponseKeyRepository' => ['privates', 'App\\Repository\\ServiceResponseKeyRepository', 'getServiceResponseKeyRepositoryService', false],
            ...
            'App\\Repository\\OauthAccessTokensRepository' => '?',
            'App\\Repository\\ParameterRepository' => '?',
            'App\\Repository\\PropertyRepository' => '?',
            'App\\Repository\\ProviderPropertyRepository' => '?',
            'App\\Repository\\ProviderRepository' => '?',
            'App\\Repository\\ServiceRepository' => '?',
            'App\\Repository\\ServiceRequestConfigRepository' => '?',
            'App\\Repository\\ServiceRequestParameterRepository' => '?',
            'App\\Repository\\ServiceRequestRepository' => '?',
            'App\\Repository\\ServiceRequestResponseKeyRepository' => '?',
            'App\\Repository\\ServiceResponseKeyRepository' => '?',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('api.request.sent', [0 => function () {
            return ($this->privates['App\\EventListener\\ApiSendRequestListener'] ?? $this->getApiSendRequestListenerService());
        }, 1 => 'onApiRequestSent'], 0);
        ...
        $instance->addListener('console.command', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\CreateUserEventSubscriber'] ?? $this->getCreateUserEventSubscriberService());
        }, 1 => 'createUserCommand'], 0);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    /**
     * Gets the private '.errored..service_locator.0Gc2GqG.App\Entity\Provider' shared service.
     *
     * @return \App\Entity\Provider
     */
    protected function getProviderService()
    {
        $this->throw('Cannot autowire service ".service_locator.0Gc2GqG": it references class "App\\Entity\\Provider" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.DYqMm5w.App\Entity\ServiceRequest' shared service.
     *
     * @return \App\Entity\ServiceRequest
     */
    protected function getServiceRequestService()
    {
        $this->throw('Cannot autowire service ".service_locator.DYqMm5w": it references class "App\\Entity\\ServiceRequest" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.FbNqKZ7.App\Entity\ServiceRequestConfig' shared service.
     *
     * @return \App\Entity\ServiceRequestConfig
     */
    protected function getServiceRequestConfigService()
    {
        $this->throw('Cannot autowire service ".service_locator.FbNqKZ7": it references class "App\\Entity\\ServiceRequestConfig" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.KyvvMw7.App\Entity\ServiceRequestParameter' shared service.
     *
     * @return \App\Entity\ServiceRequestParameter
     */
    protected function getServiceRequestParameterService()
    {
        $this->throw('Cannot autowire service ".service_locator.KyvvMw7": it references class "App\\Entity\\ServiceRequestParameter" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.Lizx8t3.App\Entity\ServiceResponseKey' shared service.
     *
     * @return \App\Entity\ServiceResponseKey
     */
    protected function getServiceResponseKeyService()
    {
        $this->throw('Cannot autowire service ".service_locator.Lizx8t3": it references class "App\\Entity\\ServiceResponseKey" but no such service exists.');
    }
    ...
    /**
     * Gets the private '.errored..service_locator.hOPW2XV.App\Entity\ApiToken' shared service.
     *
     * @return \App\Entity\ApiToken
     */
    protected function getApiTokenService()
    {
        $this->throw('Cannot autowire service ".service_locator.hOPW2XV": it references class "App\\Entity\\ApiToken" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.ry.j167.App\Entity\Service' shared service.
     *
     * @return \App\Entity\Service
     */
    protected function getServiceService()
    {
        $this->throw('Cannot autowire service ".service_locator.ry.j167": it references class "App\\Entity\\Service" but no such service exists.');
    }

    /**
     * Gets the private '.service_locator.0Gc2GqG' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_0Gc2GqGService()
    {
        return $this->privates['.service_locator.0Gc2GqG'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'provider' => ['privates', '.errored..service_locator.0Gc2GqG.App\\Entity\\Provider', NULL, 'Cannot autowire service ".service_locator.0Gc2GqG": it references class "App\\Entity\\Provider" but no such service exists.'],
        ], [
    ...
    /**
     * Gets the private '.service_locator.6H39Oyu' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_6H39OyuService()
    {
        return $this->privates['.service_locator.6H39Oyu'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\Api\\Backend\\AdminController::generateNewApiToken' => ['privates', '.service_locator.VPb8Zl0', 'get_ServiceLocator_VPb8Zl0Service', false],
            'App\\Controller\\Api\\Backend\\AdminController::getApiToken' => ['privates', '.service_locator.hOPW2XV', 'get_ServiceLocator_HOPW2XVService', false],
            'App\\Controller\\Api\\Backend\\AdminController::getSingleUser' => ['privates', '.service_locator.VPb8Zl0', 'get_ServiceLocator_VPb8Zl0Service', false],
            'App\\Controller\\Api\\Backend\\AdminController::getSingleUserByApiToken' => ['privates', '.service_locator.PTnzJeF', 'get_ServiceLocator_PTnzJeFService', false],
            'App\\Controller\\Api\\Backend\\AdminController::getUserApiTokens' => ['privates', '.service_locator.VPb8Zl0', 'get_ServiceLocator_VPb8Zl0Service', false],
            'App\\Controller\\Api\\Backend\\CategoryController::getSingleCategory' => ['privates', '.service_locator.MpsgFRY', 'get_ServiceLocator_MpsgFRYService', false],
            'App\\Controller\\Api\\Backend\\PropertyController::getProperty' => ['privates', '.service_locator.WCQZPh.', 'get_ServiceLocator_WCQZPh_Service', false],
            'App\\Controller\\Api\\Backend\\ProviderController::getProvider' => ['privates', '.service_locator.0Gc2GqG', 'get_ServiceLocator_0Gc2GqGService', false],
            'App\\Controller\\Api\\Backend\\ProviderController::getProviderProperty' => ['privates', '.service_locator.0Gc2GqG', 'get_ServiceLocator_0Gc2GqGService', false],
            'App\\Controller\\Api\\Backend\\ProviderController::getProviderPropertyList' => ['privates', '.service_locator.0Gc2GqG', 'get_ServiceLocator_0Gc2GqGService', false],
            'App\\Controller\\Api\\Backend\\Services\\ServiceController::getService' => ['privates', '.service_locator.ry.j167', 'get_ServiceLocator_Ry_J167Service', false],
            'App\\Controller\\Api\\Backend\\Services\\ServiceRequestConfigController::getServiceRequestConfig' => ['privates', '.service_locator.FbNqKZ7', 'get_ServiceLocator_FbNqKZ7Service', false],
            'App\\Controller\\Api\\Backend\\Services\\ServiceRequestController::getServiceRequest' => ['privates', '.service_locator.DYqMm5w', 'get_ServiceLocator_DYqMm5wService', false],
            'App\\Controller\\Api\\Backend\\Services\\ServiceRequestController::runApiRequest' => ['privates', '.service_locator.hK5zclx', 'get_ServiceLocator_HK5zclxService', false],
            'App\\Controller\\Api\\Backend\\Services\\ServiceRequestParameterController::getServiceRequestParameter' => ['privates', '.service_locator.KyvvMw7', 'get_ServiceLocator_KyvvMw7Service', false],
            'App\\Controller\\Api\\Backend\\Services\\ServiceRequestResponseKeyController::getRequestResponseKey' => ['privates', '.service_locator.DYqMm5w', 'get_ServiceLocator_DYqMm5wService', false],
            'App\\Controller\\Api\\Backend\\Services\\ServiceRequestResponseKeyController::getRequestResponseKeyList' => ['privates', '.service_locator.DYqMm5w', 'get_ServiceLocator_DYqMm5wService', false],
            'App\\Controller\\Api\\Backend\\Services\\ServiceResponseKeyController::getServiceResponseKey' => ['privates', '.service_locator.Lizx8t3', 'get_ServiceLocator_Lizx8t3Service', false],
            'App\\Controller\\Api\\Frontend\\ListController::getCategoryProviderList' => ['privates', '.service_locator.MpsgFRY', 'get_ServiceLocator_MpsgFRYService', false],
            'App\\Controller\\Api\\Frontend\\OperationsController::searchOperation' => ['privates', '.service_locator.hK5zclx', 'get_ServiceLocator_HK5zclxService', false],
            'App\\Controller\\Api\\Backend\\AdminController:generateNewApiToken' => ['privates', '.service_locator.VPb8Zl0', 'get_ServiceLocator_VPb8Zl0Service', false],
            'App\\Controller\\Api\\Backend\\AdminController:getApiToken' => ['privates', '.service_locator.hOPW2XV', 'get_ServiceLocator_HOPW2XVService', false],
            'App\\Controller\\Api\\Backend\\AdminController:getSingleUser' => ['privates', '.service_locator.VPb8Zl0', 'get_ServiceLocator_VPb8Zl0Service', false],
            'App\\Controller\\Api\\Backend\\AdminController:getSingleUserByApiToken' => ['privates', '.service_locator.PTnzJeF', 'get_ServiceLocator_PTnzJeFService', false],
            ...
            'App\\Controller\\Api\\Backend\\AdminController::generateNewApiToken' => '?',
            'App\\Controller\\Api\\Backend\\AdminController::getApiToken' => '?',
            'App\\Controller\\Api\\Backend\\AdminController::getSingleUser' => '?',
            'App\\Controller\\Api\\Backend\\AdminController::getSingleUserByApiToken' => '?',
            'App\\Controller\\Api\\Backend\\AdminController::getUserApiTokens' => '?',
            'App\\Controller\\Api\\Backend\\CategoryController::getSingleCategory' => '?',
            'App\\Controller\\Api\\Backend\\PropertyController::getProperty' => '?',
            'App\\Controller\\Api\\Backend\\ProviderController::getProvider' => '?',
            'App\\Controller\\Api\\Backend\\ProviderController::getProviderProperty' => '?',
            'App\\Controller\\Api\\Backend\\ProviderController::getProviderPropertyList' => '?',
            'App\\Controller\\Api\\Backend\\Services\\ServiceController::getService' => '?',
            'App\\Controller\\Api\\Backend\\Services\\ServiceRequestConfigController::getServiceRequestConfig' => '?',
            'App\\Controller\\Api\\Backend\\Services\\ServiceRequestController::getServiceRequest' => '?',
            'App\\Controller\\Api\\Backend\\Services\\ServiceRequestController::runApiRequest' => '?',
            'App\\Controller\\Api\\Backend\\Services\\ServiceRequestParameterController::getServiceRequestParameter' => '?',
            'App\\Controller\\Api\\Backend\\Services\\ServiceRequestResponseKeyController::getRequestResponseKey' => '?',
            'App\\Controller\\Api\\Backend\\Services\\ServiceRequestResponseKeyController::getRequestResponseKeyList' => '?',
            'App\\Controller\\Api\\Backend\\Services\\ServiceResponseKeyController::getServiceResponseKey' => '?',
            'App\\Controller\\Api\\Frontend\\ListController::getCategoryProviderList' => '?',
            'App\\Controller\\Api\\Frontend\\OperationsController::searchOperation' => '?',
            'App\\Controller\\Api\\Backend\\AdminController:generateNewApiToken' => '?',
            'App\\Controller\\Api\\Backend\\AdminController:getApiToken' => '?',
            'App\\Controller\\Api\\Backend\\AdminController:getSingleUser' => '?',
            'App\\Controller\\Api\\Backend\\AdminController:getSingleUserByApiToken' => '?',
    ...
    /**
     * Gets the private '.service_locator.DYqMm5w' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_DYqMm5wService()
    {
        return $this->privates['.service_locator.DYqMm5w'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'serviceRequest' => ['privates', '.errored..service_locator.DYqMm5w.App\\Entity\\ServiceRequest', NULL, 'Cannot autowire service ".service_locator.DYqMm5w": it references class "App\\Entity\\ServiceRequest" but no such service exists.'],
        ], [
            'serviceRequest' => 'App\\Entity\\ServiceRequest',
        ]);
    }

    /**
     * Gets the private '.service_locator.FbNqKZ7' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_FbNqKZ7Service()
    {
        return $this->privates['.service_locator.FbNqKZ7'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'serviceRequestConfig' => ['privates', '.errored..service_locator.FbNqKZ7.App\\Entity\\ServiceRequestConfig', NULL, 'Cannot autowire service ".service_locator.FbNqKZ7": it references class "App\\Entity\\ServiceRequestConfig" but no such service exists.'],
        ], [
            'serviceRequestConfig' => 'App\\Entity\\ServiceRequestConfig',
        ]);
    }

    /**
     * Gets the private '.service_locator.KyvvMw7' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_KyvvMw7Service()
    {
        return $this->privates['.service_locator.KyvvMw7'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'serviceRequestParameter' => ['privates', '.errored..service_locator.KyvvMw7.App\\Entity\\ServiceRequestParameter', NULL, 'Cannot autowire service ".service_locator.KyvvMw7": it references class "App\\Entity\\ServiceRequestParameter" but no such service exists.'],
        ], [
            'serviceRequestParameter' => 'App\\Entity\\ServiceRequestParameter',
        ]);
    }

    /**
     * Gets the private '.service_locator.Lizx8t3' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Lizx8t3Service()
    {
        return $this->privates['.service_locator.Lizx8t3'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'serviceResponseKey' => ['privates', '.errored..service_locator.Lizx8t3.App\\Entity\\ServiceResponseKey', NULL, 'Cannot autowire service ".service_locator.Lizx8t3": it references class "App\\Entity\\ServiceResponseKey" but no such service exists.'],
        ], [
            'serviceResponseKey' => 'App\\Entity\\ServiceResponseKey',
        ]);
    }
    ...
    /**
     * Gets the private '.service_locator.PTnzJeF' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_PTnzJeFService()
    {
        return $this->privates['.service_locator.PTnzJeF'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'securityService' => ['privates', 'App\\Service\\SecurityService', 'getSecurityServiceService', false],
        ], [
    ...
    /**
     * Gets the private '.service_locator.hK5zclx' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_HK5zclxService()
    {
        return $this->privates['.service_locator.hK5zclx'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'requestOperation' => ['privates', 'App\\Service\\Api\\Operations\\RequestOperation', 'getRequestOperationService', false],
        ], [
            'requestOperation' => 'App\\Service\\Api\\Operations\\RequestOperation',
        ]);
    }

    /**
     * Gets the private '.service_locator.hOPW2XV' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_HOPW2XVService()
    {
        return $this->privates['.service_locator.hOPW2XV'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'apiToken' => ['privates', '.errored..service_locator.hOPW2XV.App\\Entity\\ApiToken', NULL, 'Cannot autowire service ".service_locator.hOPW2XV": it references class "App\\Entity\\ApiToken" but no such service exists.'],
        ], [
    ...
    /**
     * Gets the private '.service_locator.ry.j167' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Ry_J167Service()
    {
        return $this->privates['.service_locator.ry.j167'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'service' => ['privates', '.errored..service_locator.ry.j167.App\\Entity\\Service', NULL, 'Cannot autowire service ".service_locator.ry.j167": it references class "App\\Entity\\Service" but no such service exists.'],
        ], [
    ...
    /**
     * Gets the private 'App\Command\CreateProviderCommand' shared autowired service.
     *
     * @return \App\Command\CreateProviderCommand
     */
    protected function getCreateProviderCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/CreateProviderCommand.php';

        $this->privates['App\\Command\\CreateProviderCommand'] = $instance = new \App\Command\CreateProviderCommand();

        $instance->setName('app:create-provider');
    ...
    /**
     * Gets the private 'App\Command\DeleteProviderCommand' shared autowired service.
     *
     * @return \App\Command\DeleteProviderCommand
     */
    protected function getDeleteProviderCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/DeleteProviderCommand.php';

        $this->privates['App\\Command\\DeleteProviderCommand'] = $instance = new \App\Command\DeleteProviderCommand();

        $instance->setName('app:delete-provider');

        return $instance;
    }

    /**
     * Gets the private 'App\EventListener\ApiSendRequestListener' shared autowired service.
     *
     * @return \App\EventListener\ApiSendRequestListener
     */
    protected function getApiSendRequestListenerService()
    {
        include_once \dirname(__DIR__, 4).'/src/EventListener/ApiSendRequestListener.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Api/ApiBase.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Api/Client/ApiClientHandler.php';

        return $this->privates['App\\EventListener\\ApiSendRequestListener'] = new \App\EventListener\ApiSendRequestListener(($this->privates['App\\Service\\Api\\Client\\ApiClientHandler'] ?? ($this->privates['App\\Service\\Api\\Client\\ApiClientHandler'] = new \App\Service\Api\Client\ApiClientHandler())));
    }

    /**
     * Gets the private 'App\EventSubscriber\CreateUserEventSubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\CreateUserEventSubscriber
     */
    protected function getCreateUserEventSubscriberService()
    {
        include_once \dirname(__DIR__, 4).'/src/EventSubscriber/CreateUserEventSubscriber.php';

        return $this->privates['App\\EventSubscriber\\CreateUserEventSubscriber'] = new \App\EventSubscriber\CreateUserEventSubscriber(($this->privates['App\\Service\\UserService'] ?? $this->getUserServiceService()));
    }
    ...
    /**
     * Gets the private 'App\Repository\OauthAccessTokensRepository' shared autowired service.
     *
     * @return \App\Repository\OauthAccessTokensRepository
     */
    protected function getOauthAccessTokensRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/OauthAccessTokensRepository.php';

        return $this->privates['App\\Repository\\OauthAccessTokensRepository'] = new \App\Repository\OauthAccessTokensRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    /**
     * Gets the private 'App\Repository\ProviderPropertyRepository' shared autowired service.
     *
     * @return \App\Repository\ProviderPropertyRepository
     */
    protected function getProviderPropertyRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/ProviderPropertyRepository.php';

        return $this->privates['App\\Repository\\ProviderPropertyRepository'] = new \App\Repository\ProviderPropertyRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    /**
     * Gets the private 'App\Repository\ServiceRequestConfigRepository' shared autowired service.
     *
     * @return \App\Repository\ServiceRequestConfigRepository
     */
    protected function getServiceRequestConfigRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/ServiceRequestConfigRepository.php';

        return $this->privates['App\\Repository\\ServiceRequestConfigRepository'] = new \App\Repository\ServiceRequestConfigRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\ServiceRequestParameterRepository' shared autowired service.
     *
     * @return \App\Repository\ServiceRequestParameterRepository
     */
    protected function getServiceRequestParameterRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/ServiceRequestParameterRepository.php';

        return $this->privates['App\\Repository\\ServiceRequestParameterRepository'] = new \App\Repository\ServiceRequestParameterRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\ServiceRequestRepository' shared autowired service.
     *
     * @return \App\Repository\ServiceRequestRepository
     */
    protected function getServiceRequestRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/ServiceRequestRepository.php';

        return $this->privates['App\\Repository\\ServiceRequestRepository'] = new \App\Repository\ServiceRequestRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\ServiceRequestResponseKeyRepository' shared autowired service.
     *
     * @return \App\Repository\ServiceRequestResponseKeyRepository
     */
    protected function getServiceRequestResponseKeyRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/ServiceRequestResponseKeyRepository.php';

        return $this->privates['App\\Repository\\ServiceRequestResponseKeyRepository'] = new \App\Repository\ServiceRequestResponseKeyRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\ServiceResponseKeyRepository' shared autowired service.
     *
     * @return \App\Repository\ServiceResponseKeyRepository
     */
    protected function getServiceResponseKeyRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/ServiceResponseKeyRepository.php';

        return $this->privates['App\\Repository\\ServiceResponseKeyRepository'] = new \App\Repository\ServiceResponseKeyRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
     ...
     */
    protected function getApiAuthenticatorService()
    {
        ...
        return $this->privates['App\\Security\\ApiAuthenticator'] = new \App\Security\ApiAuthenticator(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\SecurityService'] ?? $this->getSecurityServiceService()), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()), ($this->privates['App\\Repository\\ApiTokenRepository'] ?? $this->getApiTokenRepositoryService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()), ($this->privates['App\\Service\\UserService'] ?? $this->getUserServiceService()));
    }
    ...
    protected function getApiTokenAuthenticatorService()
    {
        ...
        return $this->privates['App\\Security\\ApiTokenAuthenticator'] = new \App\Security\ApiTokenAuthenticator(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\SecurityService'] ?? $this->getSecurityServiceService()));
    }
    ...
    /**
     * Gets the private 'App\Service\ApiServicesService' shared autowired service.
     *
     * @return \App\Service\ApiServicesService
     */
    protected function getApiServicesServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/ApiServicesService.php';

        return $this->privates['App\\Service\\ApiServicesService'] = new \App\Service\ApiServicesService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()));
    }

    /**
     * Gets the private 'App\Service\Api\Operations\RequestOperation' shared autowired service.
     *
     * @return \App\Service\Api\Operations\RequestOperation
     */
    protected function getRequestOperationService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/Api/ApiBase.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Api/Operations/BaseOperations.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Api/Operations/RequestOperation.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Api/Client/ApiClientHandler.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Api/Client/Oauth/Oauth.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Api/Response/ResponseManager.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Api/Response/Handlers/ResponseHandler.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Api/Response/Handlers/Json/JsonResponseHandler.php';
        include_once \dirname(__DIR__, 4).'/src/Service/XmlService.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Api/Response/Handlers/Xml/XmlResponseHandler.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Api/Client/Amazon/AmazonApiManager.php';
        include_once \dirname(__DIR__, 4).'/src/Service/Api/Client/Entity/ApiRequest.php';
        include_once \dirname(__DIR__, 4).'/src/Service/EventsService.php';
        include_once \dirname(__DIR__, 4).'/src/Service/SerializerService.php';

        $a = ($this->privates['App\\Service\\ProviderService'] ?? $this->getProviderServiceService());
        $b = ($this->privates['App\\Service\\SerializerService'] ?? ($this->privates['App\\Service\\SerializerService'] = new \App\Service\SerializerService()));
        $c = ($this->privates['App\\Service\\RequestService'] ?? $this->getRequestServiceService());
        $d = new \App\Service\XmlService();
        $e = ($this->privates['App\\Service\\ResponseKeysService'] ?? $this->getResponseKeysServiceService());

        return $this->privates['App\\Service\\Api\\Operations\\RequestOperation'] = new \App\Service\Api\Operations\RequestOperation($a, $b, new \App\Service\Api\Client\Oauth\Oauth(($this->privates['App\\Repository\\OauthAccessTokensRepository'] ?? $this->getOauthAccessTokensRepositoryService()), $b, $a), new \App\Service\Api\Response\ResponseManager(new \App\Service\Api\Response\Handlers\Json\JsonResponseHandler($a, $c, $d, $e), new \App\Service\Api\Response\Handlers\Xml\XmlResponseHandler($a, $c, $d, $e)), new \App\Service\Api\Client\Amazon\AmazonApiManager(), ($this->privates['App\\Service\\CategoryService'] ?? $this->getCategoryServiceService()), ($this->privates['App\\Service\\Api\\Client\\ApiClientHandler'] ?? ($this->privates['App\\Service\\Api\\Client\\ApiClientHandler'] = new \App\Service\Api\Client\ApiClientHandler())), new \App\Service\Api\Client\Entity\ApiRequest(), new \App\Service\EventsService(($this->privates['App\\EventListener\\ApiSendRequestListener'] ?? $this->getApiSendRequestListenerService())), $c);
    }
    ...
    protected function getCategoryServiceService()
    {
        ...
        return $this->privates['App\\Service\\CategoryService'] = new \App\Service\CategoryService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()));
    }

    /**
     * Gets the private 'App\Service\HttpRequestService' shared autowired service.
     *
     * @return \App\Service\HttpRequestService
     */
    protected function getHttpRequestServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/HttpRequestService.php';

        return $this->privates['App\\Service\\HttpRequestService'] = new \App\Service\HttpRequestService(($this->services['validator'] ?? $this->getValidatorService()));
    }

    /**
     * Gets the private 'App\Service\PropertyService' shared autowired service.
     *
     * @return \App\Service\PropertyService
     */
    protected function getPropertyServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/PropertyService.php';

        return $this->privates['App\\Service\\PropertyService'] = new \App\Service\PropertyService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()));
    }

    /**
     * Gets the private 'App\Service\ProviderService' shared autowired service.
     *
     * @return \App\Service\ProviderService
     */
    protected function getProviderServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/ProviderService.php';

        return $this->privates['App\\Service\\ProviderService'] = new \App\Service\ProviderService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()), ($this->privates['App\\Service\\PropertyService'] ?? $this->getPropertyServiceService()), ($this->privates['App\\Service\\CategoryService'] ?? $this->getCategoryServiceService()));
    }

    /**
     * Gets the private 'App\Service\RequestConfigService' shared autowired service.
     *
     * @return \App\Service\RequestConfigService
     */
    protected function getRequestConfigServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/RequestConfigService.php';

        return $this->privates['App\\Service\\RequestConfigService'] = new \App\Service\RequestConfigService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()), ($this->privates['App\\Service\\ProviderService'] ?? $this->getProviderServiceService()));
    }

    /**
     * Gets the private 'App\Service\RequestParametersService' shared autowired service.
     *
     * @return \App\Service\RequestParametersService
     */
    protected function getRequestParametersServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/RequestParametersService.php';

        return $this->privates['App\\Service\\RequestParametersService'] = new \App\Service\RequestParametersService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()));
    }
     ...
     */
    protected function getRequestServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/RequestService.php';

        return $this->privates['App\\Service\\RequestService'] = new \App\Service\RequestService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()), ($this->privates['App\\Service\\ProviderService'] ?? $this->getProviderServiceService()), ($this->privates['App\\Service\\ResponseKeysService'] ?? $this->getResponseKeysServiceService()), ($this->privates['App\\Service\\RequestConfigService'] ?? $this->getRequestConfigServiceService()), ($this->privates['App\\Service\\RequestParametersService'] ?? $this->getRequestParametersServiceService()), ($this->privates['App\\Service\\ApiServicesService'] ?? $this->getApiServicesServiceService()));
    }

    /**
     * Gets the private 'App\Service\ResponseKeysService' shared autowired service.
     *
     * @return \App\Service\ResponseKeysService
     */
    protected function getResponseKeysServiceService()
    {
        include_once \dirname(__DIR__, 4).'/src/Service/ResponseKeysService.php';

        return $this->privates['App\\Service\\ResponseKeysService'] = new \App\Service\ResponseKeysService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()));
    }
    ...
    protected function getSecurityServiceService()
    {
        ...
        return $this->privates['App\\Service\\SecurityService'] = new \App\Service\SecurityService(($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()));
    }
    ...
    protected function getUserServiceService()
    {
        ...
        return $this->privates['App\\Service\\UserService'] = new \App\Service\UserService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\HttpRequestService'] ?? $this->getHttpRequestServiceService()), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()));
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/account/new-token'), [], NULL);
    ...
    /**
     * Gets the private 'security.authentication.listener.guard.account' shared service.
     *
     * @return \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener
     */
    protected function getSecurity_Authentication_Listener_Guard_AccountService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-http/Firewall/AbstractListener.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/security-guard/Firewall/GuardAuthenticationListener.php';

        return $this->privates['security.authentication.listener.guard.account'] = new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener(($this->privates['security.authentication.guard_handler'] ?? $this->getSecurity_Authentication_GuardHandlerService()), ($this->privates['security.authentication.manager'] ?? $this->getSecurity_Authentication_ManagerService()), 'account', new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\ApiAuthenticator'] ?? $this->getApiAuthenticatorService());
    ...
    protected function getSecurity_Authentication_Listener_Guard_ApiService()
    {
        ...
        return $this->privates['security.authentication.listener.guard.api'] = new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener(($this->privates['security.authentication.guard_handler'] ?? $this->getSecurity_Authentication_GuardHandlerService()), ($this->privates['security.authentication.manager'] ?? $this->getSecurity_Authentication_ManagerService()), 'api', new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\ApiTokenAuthenticator'] ?? $this->getApiTokenAuthenticatorService());
        }, 1), ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()));
    }
    ...
    protected function getSecurity_Authentication_Listener_Guard_DefaultService()
    {
        ...
        return $this->privates['security.authentication.listener.guard.default'] = new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener(($this->privates['security.authentication.guard_handler'] ?? $this->getSecurity_Authentication_GuardHandlerService()), ($this->privates['security.authentication.manager'] ?? $this->getSecurity_Authentication_ManagerService()), 'default', new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\ApiTokenAuthenticator'] ?? $this->getApiTokenAuthenticatorService());
            yield 1 => ($this->privates['App\\Security\\LoginFormAuthenticator'] ?? $this->getLoginFormAuthenticatorService());
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.authentication.provider.guard.account'] ?? $this->getSecurity_Authentication_Provider_Guard_AccountService());
    ...
    /**
     * Gets the private 'security.authentication.provider.guard.account' shared service.
     *
     * @return \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider
     */
    protected function getSecurity_Authentication_Provider_Guard_AccountService()
    {
        ...
        return $this->privates['security.authentication.provider.guard.account'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\ApiAuthenticator'] ?? $this->getApiAuthenticatorService());
        }, 1), ($this->privates['security.user.provider.concrete.app_user_provider'] ?? $this->getSecurity_User_Provider_Concrete_AppUserProviderService()), 'account', ($this->privates['security.user_checker'] ?? ($this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker())), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()));
    }
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'security.firewall.map.context.account' => ['privates', 'security.firewall.map.context.account', 'getSecurity_Firewall_Map_Context_AccountService', false],
            ...
            'security.firewall.map.context.account' => '?',
            'security.firewall.map.context.api' => '?',
            'security.firewall.map.context.default' => '?',
            'security.firewall.map.context.dev' => '?',
        ]), new RewindableGenerator(function () {
            yield 'security.firewall.map.context.dev' => ($this->privates['.security.request_matcher.Iy.T22O'] ?? ($this->privates['.security.request_matcher.Iy.T22O'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/')));
            yield 'security.firewall.map.context.account' => ($this->privates['.security.request_matcher.xd6mRah'] ?? ($this->privates['.security.request_matcher.xd6mRah'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/account/')));
    ...
    /**
     * Gets the private 'security.firewall.map.context.account' shared service.
     *
    ...
    protected function getSecurity_Firewall_Map_Context_AccountService()
    {
        ...
        return $this->privates['security.firewall.map.context.account'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
            yield 0 => ($this->privates['security.channel_listener'] ?? $this->getSecurity_ChannelListenerService());
            yield 1 => ($this->privates['security.context_listener.0'] ?? $this->getSecurity_ContextListener_0Service());
            yield 2 => ($this->privates['security.authentication.listener.guard.account'] ?? $this->getSecurity_Authentication_Listener_Guard_AccountService());
            yield 3 => ($this->privates['security.access_listener'] ?? $this->getSecurity_AccessListenerService());
        }, 4), new \Symfony\Component\Security\Http\Firewall\ExceptionListener(($this->services['security.token_storage'] ?? $this->getSecurity_TokenStorageService()), ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver())), ($this->privates['security.http_utils'] ?? $this->getSecurity_HttpUtilsService()), 'account', ($this->privates['App\\Security\\ApiAuthenticator'] ?? $this->getApiAuthenticatorService()), NULL, NULL, ($this->privates['monolog.logger.security'] ?? $this->getMonolog_Logger_SecurityService()), false), NULL, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('account', 'security.user_checker', '.security.request_matcher.xd6mRah', true, false, 'security.user.provider.concrete.app_user_provider', 'account', 'App\\Security\\ApiAuthenticator', NULL, NULL, [0 => 'guard'], NULL));
    }
