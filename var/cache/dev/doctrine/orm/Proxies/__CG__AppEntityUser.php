...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\Entity\\User' . "\0" . 'username', '' . "\0" . 'App\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'App\\Entity\\User' . "\0" . 'password', '' . "\0" . 'App\\Entity\\User' . "\0" . 'date_updated', '' . "\0" . 'App\\Entity\\User' . "\0" . 'date_added', '' . "\0" . 'App\\Entity\\User' . "\0" . 'apiTokens'];
        }
     ...
     * {@inheritDoc}
     */
    public function setDateUpdated(\DateTimeInterface $date_updated): \App\Entity\User
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateUpdated', [$date_updated]);

        return parent::setDateUpdated($date_updated);
    }
     ...
     * {@inheritDoc}
     */
    public function setDateAdded(\DateTimeInterface $date_added): \App\Entity\User
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateAdded', [$date_added]);
